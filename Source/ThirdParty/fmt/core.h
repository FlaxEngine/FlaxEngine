...
inline Container& get_container(fmt::back_insert_iterator<Container> it) {
  using bi_iterator = fmt::back_insert_iterator<Container>;
...
using buffer_context =
    basic_format_context<fmt::back_insert_iterator<internal::buffer<Char>>,
                         Char>;
...
inline fmt::back_insert_iterator<Container> format_to(
    fmt::back_insert_iterator<Container> out, const S& format_str,
    Args&&... args) {
