...
bool FontManager::AddNewEntry(Font* font, Char c, FontCharacterEntry& entry)
{
    ...
    if (static_cast<int32>(options.Flags & FontFlags::AntiAliasing))
    {
    ...
    if (static_cast<int32>(options.Flags & FontFlags::Bold))
    {
        FT_GlyphSlot_Embolden(face->glyph);
    }
    if (static_cast<int32>(options.Flags & FontFlags::Italic))
    {
    ...
    FT_Render_Glyph(glyph, static_cast<int32>(options.Flags & FontFlags::AntiAliasing) ? FT_RENDER_MODE_NORMAL : FT_RENDER_MODE_MONO);
