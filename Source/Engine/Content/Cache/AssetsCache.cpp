...
void AssetsCache::Init()
{
    ...
    if (!static_cast<int32>(flags & AssetsCacheFlags::RelativePaths) && workspacePath != Globals::StartupFolder)
    {
    ...
    for (int32 i = 0; i < count; i++)
    {
        ...
        if (static_cast<int32>(flags & AssetsCacheFlags::RelativePaths) && e.Info.Path.HasChars())
        {
    ...
    for (int32 i = 0; i < count; i++)
    {
        ...
        if (static_cast<int32>(flags & AssetsCacheFlags::RelativePaths) && mappedPath.HasChars())
        {
            // Convert to absolute path
