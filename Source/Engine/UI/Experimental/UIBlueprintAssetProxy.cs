...
namespace FlaxEditor.Experimental.UI
{
    ...
    /// <inheritdoc />
    public class UIBrushAssetItem : JsonAssetItem
    {
        /// <inheritdoc />
        public UIBrushAssetItem(string path, Guid id, string typeName)
    ...
    /// <inheritdoc />
    [ContentContextMenu("New/Experimental/UI/Brush")]
    public sealed class UIBrushAssetProxy : JsonAssetProxy
    {
        /// <inheritdoc />
        public static readonly string AssetTypename = typeof(UIBrushAsset).FullName;
