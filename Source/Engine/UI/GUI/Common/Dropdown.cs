    ...
    public class Dropdown : ContainerControl
    {
        ...
        protected virtual Control CreatePopupItem(int i, Float2 size, float margin)
        {
            ...
            var label = new DropdownLabel
            {
                ...
                TextColorHighlighted = (BackgroundColorSelected.Brightness < 0.05f && TextColorHighlighted.Brightness < 0.05f) ? Color.Lerp(TextColorHighlighted, Color.White, 0.3f) : TextColorHighlighted,
