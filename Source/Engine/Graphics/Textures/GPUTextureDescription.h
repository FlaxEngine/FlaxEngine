...
public:
    ...
    {
        return static_cast<int32>(Flags & GPUTextureFlags::RenderTarget) != 0;
    }
    ...
    {
        return static_cast<int32>(Flags & GPUTextureFlags::DepthStencil) != 0;
    }
    ...
    {
        return static_cast<int32>(Flags & GPUTextureFlags::ShaderResource) != 0;
    }
    ...
    {
        return static_cast<int32>(Flags & GPUTextureFlags::UnorderedAccess) != 0;
    }
    ...
    {
        return static_cast<int32>(Flags & GPUTextureFlags::PerMipViews) != 0;
    }
    ...
    {
        return static_cast<int32>(Flags & GPUTextureFlags::PerSliceViews) != 0;
    }
