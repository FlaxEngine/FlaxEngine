...
namespace Flax.Deps.Dependencies
{
    ...
    class Assimp : Dependency
    {
        ...
        public override void Build(BuildOptions options)
        {
            ...
            // Get the source
            CloneGitRepoFast(root, "https://github.com/FlaxEngine/assimp.git");
            GitCheckout(root, "master", "684f65176338b1bd391404ea43a89c5e028b8468");
            ...
            foreach (var platform in options.Platforms)
            {
                ...
                case TargetPlatform.Windows:
                {
                    ...
                    var binariesWin = new[]
                    {
                        Path.Combine("code", configuration, "assimp-vc140-md.dll"),
                        Path.Combine("code", configuration, "assimp-vc140-md.lib"),
                    };
                    ...
                    foreach (var architecture in new[] { TargetArchitecture.x64, TargetArchitecture.ARM64 })
                    {
                        ...
                        RunCmake(root, platform, architecture, $"-B\"{buildDir}\" -DLIBRARY_SUFFIX=-vc140-md");
