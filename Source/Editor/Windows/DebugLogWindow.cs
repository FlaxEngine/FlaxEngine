...
namespace FlaxEditor.Windows
{
    ...
    public class DebugLogWindow : EditorWindow
    {
        ...
        : base(editor, true, ScrollBars.None)
        {
            ...
            bool collapse = true;
            if (Editor.ProjectCache.TryGetCustomData("OutputLogCollapse", out var collapseString))
                if (bool.TryParse(collapseString, out var setCollapse))
                    collapse = setCollapse;
            _collapseLogsButton = (ToolStripButton)toolstrip.AddButton("Collapse", () => Editor.ProjectCache.SetCustomData("OutputLogCollapse", _collapseLogsButton.Checked.ToString())).SetAutoCheck(true).SetChecked(collapse).LinkTooltip("Collapses similar logs.");
