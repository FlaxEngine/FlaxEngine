...
namespace FlaxEditor.Modules
{
    ...
    public sealed class UIModule : EditorModule
    {
        ...
        private void OnOptionsChanged(EditorOptions options)
        {
            ...
            _menuFileSaveAll.ShortKeys = inputOptions.Save.ToDisplayString();
            _menuFileSaveScenes.ShortKeys = inputOptions.SaveScenes.ToDisplayString();
            _menuFileCloseScenes.ShortKeys = inputOptions.CloseScenes.ToDisplayString();
            _menuFileOpenScriptsProject.ShortKeys = inputOptions.OpenScriptsProject.ToDisplayString();
            _menuFileGenerateScriptsProjectFiles.ShortKeys = inputOptions.GenerateScriptsProject.ToDisplayString();
            _menuFileRecompileScripts.ShortKeys = inputOptions.RecompileScripts.ToDisplayString();
            _menuEditUndo.ShortKeys = inputOptions.Undo.ToDisplayString();
            _menuEditRedo.ShortKeys = inputOptions.Redo.ToDisplayString();
            _menuEditCut.ShortKeys = inputOptions.Cut.ToDisplayString();
            _menuEditCopy.ShortKeys = inputOptions.Copy.ToDisplayString();
            _menuEditDelete.ShortKeys = inputOptions.Delete.ToDisplayString();
            _menuEditDuplicate.ShortKeys = inputOptions.Duplicate.ToDisplayString();
            _menuEditSelectAll.ShortKeys = inputOptions.SelectAll.ToDisplayString();
            _menuEditDeselectAll.ShortKeys = inputOptions.DeselectAll.ToDisplayString();
            _menuEditFind.ShortKeys = inputOptions.Search.ToDisplayString();
            _menuGamePlayGame.ShortKeys = inputOptions.Play.ToDisplayString();
            _menuGamePlayCurrentScenes.ShortKeys = inputOptions.PlayCurrentScenes.ToDisplayString();
            _menuGamePause.ShortKeys = inputOptions.Pause.ToDisplayString();
            _menuGameStop.ShortKeys = inputOptions.Play.ToDisplayString();
            _menuGameCookAndRun.ShortKeys = inputOptions.CookAndRun.ToDisplayString();
            _menuGameRunCookedGame.ShortKeys = inputOptions.RunCookedGame.ToDisplayString();
            _menuToolsBuildScenes.ShortKeys = inputOptions.BuildScenesData.ToDisplayString();
            _menuToolsBakeLightmaps.ShortKeys = inputOptions.BakeLightmaps.ToDisplayString();
            _menuToolsClearLightmaps.ShortKeys = inputOptions.ClearLightmaps.ToDisplayString();
            _menuToolsBakeAllEnvProbes.ShortKeys = inputOptions.BakeEnvProbes.ToDisplayString();
            _menuToolsBuildCSGMesh.ShortKeys = inputOptions.BuildCSG.ToDisplayString();
            _menuToolsBuildNavMesh.ShortKeys = inputOptions.BuildNav.ToDisplayString();
            _menuToolsBuildAllMeshesSDF.ShortKeys = inputOptions.BuildSDF.ToDisplayString();
            _menuToolsProfilerWindow.ShortKeys = inputOptions.ProfilerWindow.ToDisplayString();
            _menuToolsTakeScreenshot.ShortKeys = inputOptions.TakeScreenshot.ToDisplayString();
